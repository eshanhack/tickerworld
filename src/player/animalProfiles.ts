...
/**
 * Species keep a common network-safe top speed (never above 7.15u/s) while
 * feeling materially different through mass, acceleration, stride and jump.
